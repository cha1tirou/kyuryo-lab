...
export const metadata: Metadata = {
  title: "給与計算の残業代算出方法を完全解説 | 割増率・計算例つき | 給料ラボ",
  description:
    "給与計算における残業代の計算方法を、基礎時給の求め方から割増率の種類、具体的な計算例まで徹底解説。月60時間超の50%割増にも対応。",
  keywords: "残業代,計算方法,割増率,基礎時給,時間外労働,深夜残業",
  alternates: { canonical: "/guide/kyuuyo-keisan-zangyou-houhou" },
  openGraph: {
    title: "給与計算の残業代算出方法を完全解説 | 割増率・計算例つき",
    description: "給与計算における残業代の計算方法を基礎時給から割増率まで徹底解説。",
    type: "article",
  },
};
...
export default function ZangyoudaiKeisanPage() {
  return (
    <>
      <Header />
      <ArticleJsonLd
        headline="給与計算の残業代算出方法を完全解説 | 割増率・計算例つき"
        description="給与計算における残業代の計算方法を、基礎時給の求め方から割増率の種類、具体的な計算例まで徹底解説。"
      ...
      <BreadcrumbJsonLd
        items={[
          ...
          { name: "残業代の計算方法", url: "https://kyuryo-lab.com/guide/kyuuyo-keisan-zangyou-houhou" },
        ]}
      />
      <main className="mx-auto w-full max-w-4xl flex-1 px-4 py-8">
        <Breadcrumb items={[
          ...
          { name: "残業代の計算方法", href: "/guide/kyuuyo-keisan-zangyou-houhou" },
        ]} />
        <article>
