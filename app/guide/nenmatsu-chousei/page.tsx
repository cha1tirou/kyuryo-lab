    ...
    <>
      ...
      <main className="mx-auto w-full max-w-4xl flex-1 px-4 py-8">
        <Breadcrumb items={[
          ...
          { name: "年末調整の仕組み", href: "/guide/nenmatsu-chousei" },
        ]} />
        <article>
          ...
          <div className="space-y-8">
            ...
            <section className="bg-slate-50 rounded-2xl border border-slate-200 p-6">
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <a href="https://www.nta.go.jp/users/gensen/nencho/index.htm" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">
                    年末調整の仕方
                  </a>
